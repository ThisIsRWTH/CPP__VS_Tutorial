...
void detect_players(int player_type[], int *output_player1, int *output_player2);
...
bool turn_valid(const int field[SIZE_Y][SIZE_X], const int player, const int pos_x, const int pos_y)
{
	...
	//If the field is not empty, we definitely cannot occupy that position.
...
int main(void)
{
	...
	////Simulating a game for two human players
	...
	do
	{
		...
		int p1 = 0;
		int p2 = 0;
		detect_players(player_type, &p1, &p2);
...
void detect_players(int players[], int *output_player1, int *output_player2)
{
	if (players[0] == HUMAN)
	{
		*output_player1 = HUMAN;
		cout << "Player 1 is a human!"<<endl;
	}
	else if (players[0] == COMPUTER)
	{
		*output_player1 = COMPUTER;
		cout << "Player 1 is a computer!" << endl;
	}

	if (players[1] == HUMAN)
	{
		*output_player2 = HUMAN;
		cout << "Player 2 is a human!" << endl;

	}
	else if (players[1] == COMPUTER)
	{
		*output_player2 = COMPUTER;
